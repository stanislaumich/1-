...
-- Дамп структуры для таблица dmaslak.client
...
-- Дамп данных таблицы dmaslak.client: ~10 rows (приблизительно)
DELETE FROM `client`;
/*!40000 ALTER TABLE `client` DISABLE KEYS */;
INSERT INTO `client` (`n`, `fio`, `adr`, `nschet`) VALUES
...
-- Дамп структуры для таблица dmaslak.nak
CREATE TABLE IF NOT EXISTS `nak` (
  `n` int NOT NULL AUTO_INCREMENT,
  `ntovar` int NOT NULL,
  ...
  CONSTRAINT `FK_nakladnaya_klient` FOREIGN KEY (`nklient`) REFERENCES `client` (`n`),
...
-- Дамп данных таблицы dmaslak.nak: ~5 rows (приблизительно)
DELETE FROM `nak`;
/*!40000 ALTER TABLE `nak` DISABLE KEYS */;
INSERT INTO `nak` (`n`, `ntovar`, `kolvo`, `summa`, `nklient`) VALUES
	(1, 1, 3, 60, 1),
	(2, 2, 5, 100, 2),
	(3, 6, 1, 55, 6),
	(4, 7, 1, 20, 4),
	(5, 10, 5, 55, 7);
/*!40000 ALTER TABLE `nak` ENABLE KEYS */;

-- Дамп структуры для таблица dmaslak.post
...
-- Дамп данных таблицы dmaslak.post: ~10 rows (приблизительно)
DELETE FROM `post`;
/*!40000 ALTER TABLE `post` DISABLE KEYS */;
INSERT INTO `post` (`n`, `nazv`, `uradr`, `nschet`) VALUES
...
-- Дамп структуры для таблица dmaslak.sotr
...
-- Дамп данных таблицы dmaslak.sotr: ~6 rows (приблизительно)
DELETE FROM `sotr`;
/*!40000 ALTER TABLE `sotr` DISABLE KEYS */;
INSERT INTO `sotr` (`N`, `fio`, `dolg`, `obraz`, `salary`, `data`) VALUES
...
CREATE TABLE IF NOT EXISTS `tovar` (
  ...
  CONSTRAINT `FKpostavt` FOREIGN KEY (`npostav`) REFERENCES `post` (`n`)
...
-- Дамп структуры для таблица dmaslak.trans
...
-- Дамп данных таблицы dmaslak.trans: ~6 rows (приблизительно)
DELETE FROM `trans`;
/*!40000 ALTER TABLE `trans` DISABLE KEYS */;
INSERT INTO `trans` (`n`, `nomer`, `marka`, `gruz`, `god`, `fio`, `data`, `nsklad`) VALUES
...
CREATE TABLE IF NOT EXISTS `zakaz` (
  ...
  CONSTRAINT `FKclientz` FOREIGN KEY (`nclient`) REFERENCES `client` (`n`),
