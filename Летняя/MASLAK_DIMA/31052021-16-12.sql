...
-- Дамп данных таблицы dmaslak.izgot: ~0 rows (приблизительно)
DELETE FROM `izgot`;
...
-- Дамп данных таблицы dmaslak.kadry: ~5 rows (приблизительно)
DELETE FROM `kadry`;
...
-- Дамп данных таблицы dmaslak.tovar: ~0 rows (приблизительно)
DELETE FROM `tovar`;
/*!40000 ALTER TABLE `tovar` DISABLE KEYS */;
INSERT INTO `tovar` (`n`, `name`, `ed`, `cena`, `postav`, `sklad`, `Kolvo`, `sort`, `izgot`) VALUES
	(1, 'Диваны', 'шт', 1500, 1, 9, 989, 1, NULL),
	(2, 'Диваны раскладные', 'шт', 3000, 2, 7, 356, 0, NULL),
	(3, 'Пуфы', 'шт', 250, 1, 10, 916, 2, NULL),
	(4, 'Кресла', 'шт', 500, 2, 8, 800, 1, NULL),
	(5, 'Подножки', 'шт', 100, 1, 4, 80, 3, NULL),
	(6, 'Стулья', 'шт', 50, 4, 3, 713, 2, NULL),
	(7, 'Книжный шкаф', 'шт', 350, 6, 4, 659, 7, NULL),
	(8, 'Лампы', 'шт', 20, 7, 9, 322, 2, NULL),
	(9, 'Кровать', 'шт', 2350, 4, 7, 740, 1, NULL),
	(10, 'Столы', 'шт', 450, 6, 3, 999, 3, NULL);
...
-- Дамп данных таблицы dmaslak.transport: ~0 rows (приблизительно)
...
-- Дамп данных таблицы dmaslak.zakaz: ~0 rows (приблизительно)
DELETE FROM `zakaz`;
